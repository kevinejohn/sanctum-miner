...
const server = new Server({
  ...
  daemons: {
    bitcoin: {
      ...
      user: 'satoshi-278grhf937fh9i83guw4f', // RPC username, setting to true will generate a random 16 bytes username
      password: '3YQ5zjKe7c2LRQbvIUppSJAHyisVlYnmG6C8YVi1JOh9QS9pK', // RPC password, setting to true will generate a random 32 bytes password
      port: 18332, // RPC port
      host: '192.168.1.186', // RPC host
...
server.on('mining', function (req, deferred, socket) {
  console.log('on mining', req.method, req.params);
  ...
  switch (req.method) {
    ...
    case 'authorize':
      ...
      deferred.promise.then(function () {
        socket.set_difficulty(['b4b6693b72a50c7116db18d6497cac52']).then(
          function () {
        ...
        socket
          .notify([
            ...
            [
              '4d31368c61b556105d936a0bf2f7d772e19375d2997fbf8d9eae5c5e089b2910',
              '012b5c89cff28de2400d192a3d8ed55b5d19f026f77d95838b3af2aefd0304a4',
            ], // branches
